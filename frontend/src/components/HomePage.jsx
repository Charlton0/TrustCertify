  ...
  return (
    <>
     ...
     <div className='w3-auto w3-text-white' style={myStyles}>
        ...
        <br/>
        <br/>
        <div className='w3-center' style={{margin: "100px"}}>
        <h2><b>Welcome to trust certify</b></h2>
        ...
        <a href="verify-certificate.html" className="cta-button w3-button" style={{backgroundColor: "#2c3e50"}}>Verify a Certificate</a>
        </div>
